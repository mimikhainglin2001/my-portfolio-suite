...
const SectionHeading = ({ eyebrow, title, align = "center", number }: Props) => (
  <div className={align === "center" ? "text-center max-w-3xl mx-auto" : ""}>
    ...
    <div className={`flex items-center gap-4 ${eyebrow ? "mt-3" : ""}`}>
      {align === "center" && <div className="h-px bg-border flex-1" />}
      <h2 className={`font-display text-3xl md:text-4xl font-bold tracking-tight whitespace-nowrap flex items-center gap-3 ${align === "center" ? "justify-center flex-shrink-0" : ""}`}>
        {number && (
